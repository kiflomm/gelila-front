...
export default async function HeroSection() {
  const pageConfig = await contactApi.getPageConfig();
  ...
  const buttonText = pageConfig.buttonText || "Get in Touch";
  const buttonHref = pageConfig.buttonHref || "/contact#contact-form";
