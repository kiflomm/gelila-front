          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center text-center md:flex-row md:text-left md:items-start gap-6 p-6 rounded-xl">
              ...
              <div>
                ...
                <p className="text-[#6C757D] dark:text-[#F8F9FA]/70 mb-4">
                  Kickstart your career with our hands-on internship programs. Gain
                  real-world experience, work with industry experts, and contribute to
                  meaningful projects.
                </p>
                <Link
            ...
            <div className="flex flex-col items-center text-center md:flex-row md:text-left md:items-start gap-6 p-6 rounded-xl">
              ...
              <div>
                ...
                <p className="text-[#6C757D] dark:text-[#F8F9FA]/70 mb-4">
                  We invest in our people. Access continuous learning opportunities,
                  professional certifications, and clear career progression pathways to
