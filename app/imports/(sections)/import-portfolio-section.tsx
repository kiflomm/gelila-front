...
import importPortfolioData from "@/data/import-portfolio.json";
...
const importPortfolios: ImportPortfolio[] =
  importPortfolioData.importPortfolios;

export default function ImportPortfolioSection() {
  return (
    <section className="py-12">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6 p-4">
        {importPortfolios.map((portfolio) => (
          <Link
            key={portfolio.id}
