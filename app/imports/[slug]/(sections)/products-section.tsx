...
export default function ProductsSection({ importItem }: ProductsSectionProps) {
    ...
    <div className="w-full">
      <div className="mb-6 sm:mb-8 md:mb-10">
        ...
        <p className="text-[#6C757D] dark:text-white/70 text-base sm:text-lg leading-relaxed">
          Explore our range of {importItem.title.toLowerCase()} products from {importItem.sourceRegion}
        </p>
      </div>
      <ProductGrid products={importItem.products} importId={importItem.id} />
    </div>
  );
}
