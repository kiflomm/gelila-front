...
type ExportProductFormData = z.infer<typeof exportProductSchema>;
...
interface ExportProductImageUploadProps {
  control: Control<ExportProductFormData>;
  errors: FieldErrors<ExportProductFormData>;
  product?: ExportProduct;
}

export function ExportProductImageUpload({
  control,
  errors,
  product,
}: ExportProductImageUploadProps) {
        ...
        render={({ field: { onChange, value, ...field } }) => (
          <div className="space-y-2">
            ...
            >
              {imagePreview ? (
                <div className="relative p-4">
                  <div className="relative w-full h-48 rounded-md overflow-hidden bg-muted group">
                    ...
                    <label
                      htmlFor="export-product-image-upload"
              ...
              <input
                {...field}
                id="export-product-image-upload"
                ref={fileInputRef}
                type="file"
                accept="image/*"
                className="hidden"
