...
type ImportProductFormData = z.infer<typeof importProductSchema>;
...
interface ImportProductImageUploadProps {
  control: Control<ImportProductFormData>;
  errors: FieldErrors<ImportProductFormData>;
  product?: ImportProduct;
}

export function ImportProductImageUpload({
  control,
  errors,
  product,
}: ImportProductImageUploadProps) {
        ...
        render={({ field: { onChange, value, ...field } }) => (
          <div className="space-y-2">
            ...
            >
              {imagePreview ? (
                <div className="relative p-4">
                  <div className="relative w-full h-48 rounded-md overflow-hidden bg-muted group">
                    ...
                    <label
                      htmlFor="import-product-image-upload"
              ...
              <input
                {...field}
                id="import-product-image-upload"
                ref={fileInputRef}
                type="file"
                accept="image/*"
                className="hidden"
